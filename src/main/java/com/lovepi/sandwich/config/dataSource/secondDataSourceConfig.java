 ...
 */
@Configuration
@MapperScan(basePackages = "com.lovepi.sandwich.mapper.test2", sqlSessionTemplateRef = "secondSqlSessionTemplate")
public class secondDataSourceConfig {
    @Value("${spring.secondDataSource.name}")
    private String dbName;
    @Value("${spring.secondDataSource.url}") //第一步中配置文件中的数据库配置信息
    private String dbUrl;
    @Value("${spring.secondDataSource.username}")//同理为配置文件中信息
    private String dbUser;
    @Value("${spring.secondDataSource.password}")//同理为配置文件信息
    ...
    @Value("${mybatis.secondDataSource.mapper-locations}")
    ...
    public DataSourceTransactionManager rdsTransactionManager(@Qualifier("secondDatasource") DataSource secondDatasource) throws SQLException {
    ...
    public SqlSessionTemplate testSqlSessionTemplate(@Qualifier("secondSessionFactory") SqlSessionFactory secondSessionFactory) throws Exception {
        return new SqlSessionTemplate(secondSessionFactory);
    }
